...
class StudentModel {
  async create(data, file) {
    ...
    try {
      ...
      const profileImage = file && file.filename ? file.filename : 'no-img.jpg';
      ...
      throw new Error(error.message.includes('academic_year_id') ? 'Invalid academic year ID' : error.message);
    } finally {
      connection.release();
    }
  }
